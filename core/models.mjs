  ...
  return [
    {
      ...
      sections: [
        ...
        { key: 'dettagli', title: 'Dettagli notevoli', type: 'points', required: true, prompt: 'Dettagli visivi notevoli in 4-6 voci: per ciascuno osservazione, significato e relazione con gli altri.' },
        ...
        { key: 'fonti', title: 'Fonti', type: 'kv', required: false, prompt: 'Fonti editoriali in 5-10 voci: titolo e URL.' },
      ],
    },
    {
    ...
    },
    {
      ...
      sections: [
        ...
        { key: 'opere', title: 'Opere rappresentative', type: 'works', withImages: true, required: true, prompt: 'Opere rappresentative 6-10 con immagini: titolo, autore, data, perché conta (max 25 parole).' },
        { key: 'simboli', title: 'Simboli ricorrenti', type: 'kv', required: false, prompt: 'Attributi e simboli ricorrenti in 5-7 voci: simbolo verso significato.' },
    ...
    },
    {
      ...
      sections: [
        { key: 'coppia', title: 'Le due opere', type: 'pair', required: true, prompt: 'Le due opere a confronto: per lato titolo, autore, data, collocazione e una riga sul perché accostate.' },
  ...
  return [
    {
      ...
      sections: [
        ...
        { key: 'citazioni', title: 'Citazioni', type: 'points', required: false, prompt: 'Citazioni 2-4: solo citazioni verificabili, con opera di provenienza.' },
  ...
  return [
    ...
    },
    {
      ...
      sections: [
        ...
        { key: 'opere', title: 'Opere ed edizioni', type: 'works', withImages: true, required: true, prompt: 'Opere ed edizioni rappresentative 4-8 con galleria semplice: titolo, autore, data, perché conta (max 25 parole).' },
